...
import (
	...
	"github.com/shivashankar-vaddepally/adc-nitro-go-latest/resource/config/network"
	"github.com/shivashankar-vaddepally/adc-nitro-go-latest/resource/config/ns"
)
