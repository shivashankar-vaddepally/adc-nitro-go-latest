...
type Nsratecontrol struct {
	...
	*/
	Tcpthreshold int `json:"tcpthreshold"` // Zero is a valid value
	/**
	* Number of UDP packets permitted per 10 milliseconds.
	*/
	Udpthreshold int `json:"udpthreshold"` // Zero is a valid value
	/**
	* Number of ICMP packets permitted per 10 milliseconds.
	*/
	Icmpthreshold int `json:"icmpthreshold"` // Zero is a valid value
	/**
	...
	*/
	Tcprstthreshold int `json:"tcprstthreshold"` // Zero is a valid value
